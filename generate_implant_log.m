function log = generate_implant_log()
    ...
    log(i).shank_orientation = [];
     ...
     % A324, left ADS (based on histology from A325)
    i=i+1;
    log(i).rat = "A324";
    log(i).serial = "19108313171";
    log(i).probe_type="10";    
    log(i).ap_group=1;
    log(i).date = "2023-07-10";
    log(i).ML_mm = 3;
    log(i).AP_mm = 1.9;
    log(i).insertion_depth_mm = 7.6;
    log(i).coronal_angle_deg = -10;
    ...
    % A324, right ADS (based on histology from A325)
    i=i+1;
    log(i).rat = "A324";
    log(i).serial = "19108318122";
    log(i).probe_type="10";    
    log(i).ap_group=1;
    log(i).date = "2023-07-10";
    log(i).ML_mm = 3;
    ...
    log(i).comments = "regions based on A325 histology";
     ...
     % A324, left TS (estimated from A325 histology and A324 ephys)
    i=i+1;
    log(i).rat = "A324";
    log(i).serial = "19108311732";
    log(i).probe_type="10";    
    log(i).ap_group=4;
    log(i).date = "2023-07-10";
    log(i).ML_mm = 5;
    ...
    log(i).shank_orientation = [];  
    log(i).comments = "regions based on A325 histology and A324 phys";
    
    
    % A324, right TS (estimated from A325 histology and A324 ephys)
    i=i+1;
    log(i).rat = "A324";
    log(i).serial = "19108313611";
    log(i).probe_type="10";    
    log(i).ap_group=4;
    log(i).date = "2023-07-10";
    log(i).ML_mm = 5;
    ...
    log(i).hemisphere = "right";
    log(i).region(1).name = "Amyg";
    log(i).region(1).electrode_range = [1 20];    
    log(i).region(2).name = "TS";
    log(i).region(2).electrode_range = [21 380];
    log(i).region(3).name = "S1";
    log(i).region(3).electrode_range = [381 960];   
    log(i).shank_orientation = [];   
    log(i).comments = "regions based on A325 histology and A324 phys";    
