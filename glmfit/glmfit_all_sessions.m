function glmfit_all_sessions(varargin)
    ...
    for i=p.Results.paths(:)'
        ...
        matlab_command = sprintf(['"fit_glm_to_Cells(''%s'',''save_path'',''%s'',''save'',true,''bin_size_s'',%0.10g,',...
            ...
            '''useGPU'',logical(%g),''relaxed'',logical(%g),''lambda'',%0.10g,''clicks_boundary'',{''%s'',''%s''},',...
            '''clicks_boundary_offset'',[%0.10g %0.10g]);"'],...
            ...
            params.relaxed,params.lambda,params.clicks_boundary{1}.params.clicks_boundary{2},params.clicks_boundary_offset(1),params.clicks_boundary_offset(2));        
