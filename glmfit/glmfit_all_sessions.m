    ...
    for i=1:length(paths)
        ...
        if p.Results.job_array && P.on_tiger
            matlab_command = sprintf(['fit_glm_to_Cells(''%s'',''save_path'',''%s'',''save'',true,''bin_size_s'',%g,',...
                ...
                '''stim_period_mode'',''%s'',''separate_clicks_by_outcome'',logical(%g));'],...
                ...
                params.stim_period_mode,params.separate_clicks_by_outcome);
            ...
            matlab_command = sprintf(['"fit_glm_to_Cells(''%s'',''save_path'',''%s'',''save'',true,''bin_size_s'',%g,',...
                ...
                '''distribution'',''%s'',''include_mono_clicks'',logical(%g),''use_trial_history'',logical(%g),''nClickBins'',%g,',...
                '''separate_clicks_by'',''%s'',''confine_clicks_to_stim_period'',logical(%g),''stim_period_boundary'',{''%s'',''%s''},'...
                '''stim_period_mode'',''%s'',''separate_clicks_by_outcome'',logical(%g));exit;"'],...
                ...
                params.separate_clicks_by,params.confine_clicks_to_stim_period,params.stim_period_boundary{:},params.stim_period_mode,params.separate_clicks_by_outcome);       
