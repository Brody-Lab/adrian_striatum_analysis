    ...
    for i=1:length(paths)
        ...
        if p.Results.job_array && P.on_cluster
            matlab_command = sprintf(['fit_glm_to_Cells(''%s'',''save_path'',''%s'',''save'',true,''bin_size_s'',%0.10g,',...
                '''kfold'',%g,''phi'',%0.10g,''tau_phi'',%0.10g,''choice_time_back_s'',%0.10g,''alpha'',%0.10g,'...
                ...
                params.tau_phi,params.choice_time_back_s,params.alpha,params.distribution,params.include_mono_clicks,params.use_trial_history,...
            ...
            matlab_command = sprintf(['"fit_glm_to_Cells(''%s'',''save_path'',''%s'',''save'',true,''bin_size_s'',%g,',...
                ...
                params.choice_time_back_s,params.alpha,params.distribution,params.include_mono_clicks,params.use_trial_history,params.nClickBins,...
