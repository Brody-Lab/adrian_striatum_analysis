...
cluster_glmfits(fits_table,glmfit_log.dm{1}.dspec,'max_clust',25,...
    'responsive_cutoff_prctile',60,'reorder_cells',false,'var_cutoff',1e-3,...
    'find_optimal_n_clust',false,'variable_bar_size',true,'reorder_cells',false,'group_by',group,'group_reorder',true);
