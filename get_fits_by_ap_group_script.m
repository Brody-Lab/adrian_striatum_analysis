...
P = get_parameters();
[glmfit_log,run] = select_glmfit_runs('distribution','poisson','lambda',3,'use_trial_history',false);
...
P = get_parameters();
[glmfit_log_no_hist,run] = select_glmfit_runs('choice_time_back_s',0.5,'use_trial_history',false);
cells_table = select_cells('is_in_dorsal_striatum',true);
