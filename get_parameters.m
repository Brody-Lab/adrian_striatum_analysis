...
function P = get_parameters()
    ...
    if ispc
        P.hostname = getenv('COMPUTERNAME');
    else
        P.hostname = getenv('HOSTNAME');
    end
    ...
    P.glmfit_catalog_keys = {'rat','recording_name','sess_date','sessid','bin_size_s','fit_method','relaxed','alpha','lambda','kfold','distribution','link','choice_time_back_s',...
        ...
        'coupling_boundary','coupling_boundary_offset','foldseed','choice'}; 
    ...
    P.covariate_order = {'previous_left_hit','previous_right_hit','previous_left_error','previous_right_error',...
                         'cpoke_in','stereo_click','left_clicks','right_clicks','pref_clicks','stereo_click_hit','stereo_click_error','left_clicks_hit','left_clicks_error',...
    ...
    P.covariate_names = {'Previous Left Correct','Previous Right Correct','Previous Left Error','Previous Right Error',...
        'Initiate Fixation','First (Stereo) Click','Left Clicks','Right Clicks','Pref Clicks','First (Stereo) Click Correct','First (Stereo) Click Error','Left Clicks Correct','Left Clicks Error','Right Clicks Correct','Right Clicks Error',...
